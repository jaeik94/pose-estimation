...
import sys
sys.path.append("recognize_anything/ram/models")
...
def generate_audio_files():
    audio_files = [
        ...
        ("nomember.mp3", "미가입 회원입니다. 가입 부탁합니다.")
    ]
...
def main():
    ...
    # 웹캠 처리 및 사람 수 계산
    args = argparse.Namespace(interval=5, pretrained='ram_plus_swin_large_14m.pth', image_size=384)
    ...
    reference_names = ["Kim Sungmin", "Kim Youngho", "Lee Jeaik", "Umida"]
